...
class TOFPublisher(Node):
    def __init__(self, options: Option):
        ...
        self.publisher_depth_ = self.create_publisher(Float32MultiArray, "raw_depth", 1)
        self.running_ = True
        #self.timer_ = self.create_timer(1/3, self.publish_depth_data)  # 3 Hz
        self.timer_ = self.create_timer(1/2, self.publish_depth_data)  # 2 Hz
