...
from raw_data_publisher.scripts.imu_gpt import IMUSensor
...
class ImuPublisher(Node):
    def __init__(self):
        ...
        self.position_subscriber = self.create_subscription(
            ...
            10)
        self.imu_sensor = IMUSensor(alpha=0.98)  # alpha controls the blend between accelerometer and gyroscope data
